...
class StyleUtilsTest {
    ...
    public void shouldGetMainFont() {
        ...
        if (StyleUtils.class.getResourceAsStream("/fonts/Itim-Regular.ttf") != null) {
            assertEquals("Itim", resultFont.getFontName(), "The font should be Itim if the custom font is available");
        } else {
