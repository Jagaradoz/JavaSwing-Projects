...
class StyleUtilsTest {
    ...
    public void shouldGetMainFont() {
        ...
        if (StyleUtils.class.getResourceAsStream("/fonts/PlaywriteGBS-VariableFont_wght.ttf") != null) {
            assertEquals("Playwrite GB S Regular", resultFont.getFontName(), "The font should be Itim if the custom font is available");
        } else {
